...
class $AssetsIconsGen {
  ...
  SvgGenImage get blockChaiIcon =>
      const SvgGenImage('assets/icons/block_chai_icon.svg');
  ...
  SvgGenImage get tabCycle => const SvgGenImage('assets/icons/tab_cycle.svg');

  /// File path: assets/icons/tab_handbook.svg
  SvgGenImage get tabHandbook =>
      const SvgGenImage('assets/icons/tab_handbook.svg');

  /// File path: assets/icons/tab_home.svg
  SvgGenImage get tabHome => const SvgGenImage('assets/icons/tab_home.svg');
...
class $AssetsImagesGen {
  ...
  SvgGenImage get blockChaiIcon =>
      const SvgGenImage('assets/images/block_chai_icon.svg');

  /// File path: assets/images/dashboard_chart.svg
  SvgGenImage get dashboardChart =>
      const SvgGenImage('assets/images/dashboard_chart.svg');
